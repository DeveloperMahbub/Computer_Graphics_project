...
{
    char text[120];
    sprintf(text,"BEAUTIFUL VILLAGE NATURE",5.00,8.00);
    glColor3f(0, 0, 0);
    glRasterPos2f( -30 , 12 );
...
void handleKeypress(unsigned char key, int x, int y) {
	switch (key) {
	    case  'd':
            ...
            glutCreateWindow("Beautiful village(172-15-9663)");
